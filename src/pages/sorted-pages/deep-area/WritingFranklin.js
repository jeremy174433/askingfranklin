...
class WritingFranklin extends React.Component {
    ...
    showForgotPwdForm() {
        console.log('show forgot pwd form');
    }
                            ...
                            : this.state.showSignIn ?
                                <>
                                    ...
                                    <div class="d-flex flex-column mt-3 pt-3">
                                        <ArrowTextLink onClick={this.showSignUpForm} text={t('sign.signIn.linkForgotPassword')} className="mb-3"/>
                                        <ArrowTextLink onClick={this.showForgotPwdForm} text={t('sign.signIn.linkRegister')}/>
                                    </div>
                                </>
