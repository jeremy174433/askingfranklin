...
export default class CrownPro extends React.Component {
    ...
    render() {
        return (
            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 511.925 511.925" width={this.props.width} height={this.props.height}>
                <title>Vous êtes membre Pro</title>
                <path fill="#FFC107" d="M469.333,127.962c-23.564,0-42.667,19.103-42.667,42.667c0.009,4.473,0.729,8.916,2.133,13.163
                ...
                <path fill="#FFD54F" d="M256,426.629c-95.424,0-192-21.973-192-64s96.576-64,192-64s192,21.973,192,64
